...
cd TTYD
# To Enable Agentic AI, pull & start AgentMe in parallel and enable AgentMe integration in this project
# See .env file and refer to the AgentMe documentation: https://github.com/ramikhaldi/AgentMe
```
